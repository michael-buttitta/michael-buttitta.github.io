...
(function () {
  ...
  var EDGES = [
    ...
    { a: 'internet', b: 'cloud',
      label: 'Cloud services exchange data over public internet routes or private network connections.' },
    { a: 'cloud', b: 'ai',
    ...
    { a: 'chatgpt', b: 'internet',
      label: 'HTTPS carries your prompt to the service and streams the reply back across the internet.' },
    ...
    { a: 'chatgpt', b: 'machine-learning',
      label: 'ChatGPT runs trained language models to generate replies — training and inference are different stages.' },

    { a: 'machine-learning', b: 'llm',
      label: 'LLMs scale the training loop from this page to large text datasets.' },
    { a: 'ai', b: 'llm',
    ...
    { a: 'cloud', b: 'databases', planned: true,
      label: 'Databases store and query persistent data for many cloud applications.' },
